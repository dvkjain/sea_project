...
With the train command, .xlsx and .csv files can be used to train and neural network models, using sklearn.
The target variable must always be the last column.
...
```console
sea train .\spreadsheet.xlsx --activation logistic -- scaling minmax

sea train .\spreadsheet.xlsx --epochs 150 --activation logistic

sea train .\spreadsheet.xlsx --save model.joblib
```
